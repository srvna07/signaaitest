...
async function run() {
  ...
  if (tc) {
    ...
    script = script.replace('page.locator(`input[type="text"]`)', "page.locator('input[type=\"text\"]')");
    script = script.replace('page.locator(`input[type="password"]`)', "page.locator('input[type=\"password\"]')");
