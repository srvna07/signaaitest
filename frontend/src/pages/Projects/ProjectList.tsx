...
export function ProjectList() {
  ...
  const handleDelete = async (e: React.MouseEvent, id: string) => {
    ...
    if (
      !window.confirm(
        'Are you sure you want to delete this project? This action cannot be undone and will fail if the project has existing data.',
      )
    )
      return;
            ...
            <div style={{ padding: '1.5rem' }}>
              ...
              {projects.length === 0 && !showNewForm && !loading && (
                ...
                >
                  <FolderGit2
                    size={32}
                    style={{ margin: '0 auto 1rem', color: 'var(--color-text-muted)' }}
                  />
